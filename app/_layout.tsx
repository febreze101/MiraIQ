    ...
    return (
        <Drawer.Navigator
            ...
            screenOptions={{
                drawerStyle: {
                    backgroundColor:
                        colorScheme === 'dark' ? Colors.dark.colors.surfaceVariant : Colors.light.colors.surfaceVariant,
                },
                ...
                headerTintColor: 'rgba(0, 167, 211, 1)',
                drawerInactiveTintColor: colorScheme === 'dark' ? 'white' : 'black',
            }}
        >
            <Drawer.Screen name="CaseList" component={CaseList} options={{ drawerLabel: 'Case List', headerTitle: '' }} />

            <Drawer.Screen name="Contact" component={Contact} options={{ drawerLabel: 'Contact', headerTitle: '' }} />

            <Drawer.Screen name="Profile" component={Profile} options={{ drawerLabel: 'Profile', headerTitle: '' }} />
...
export default function RootLayout() {
    const colorScheme = useColorScheme();
    const paperTheme =
        colorScheme === 'dark' ? { ...MD3DarkTheme, colors: Colors.dark } : { ...MD3LightTheme, colors: Colors.light };
